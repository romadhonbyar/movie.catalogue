package io.github.romadhonbyar.dts.movie.catalogue.local.storage.s5.ui.favorite.adapter;
...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        final String getKode = daftarFav.get(position).getKode();
        final String getNama = daftarFav.get(position).getNama();
