...
import io.github.romadhonbyar.dts.movie.catalogue.local.storage.s5.helper.FormatData;
...
import static io.github.romadhonbyar.dts.movie.catalogue.local.storage.s5.helper.FormatData.currencyFormat;
...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            ...
            if (res.getCount() == 1) {
                ...
                Log.e("JA", "APAX: " + res.getCount() + " - " + fav.getNama());
            } else {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(MovieDetailActivity.this, LanguageActivity.class);
        ...
        RetrofitClient.getInstance().getApi().getMovieDetailList(id_movie, API_KEY, language).enqueue(new Callback<MoviesDetailModel>() {
            ...
            public void onResponse(@NonNull Call<MoviesDetailModel> call, @NonNull Response<MoviesDetailModel> response) {
                if (response.code() == 200 && response.isSuccessful()) {
                    ...
                    if (res.getCount() == 1) {
                        Log.e("Data", "APAX: " + res.getCount() + " - " + fav.getNama());
                        // delete data
                        ...
                        fab.setOnClickListener(view -> {
                            Fav add = new Fav();
                            add.setKode(data.getId().toString());
                            add.setNama(data.getOriginalTitle());
