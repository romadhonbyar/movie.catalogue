...
import static io.github.romadhonbyar.dts.movie.catalogue.local.storage.s5.helper.FormatData.minuteToFullTime;
...
public class TVShowDetailActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(TVShowDetailActivity.this, LanguageActivity.class);
                ...
                if (response.code() == 200 && response.isSuccessful()) {
                    ...
                    if (res.getCount() == 1) {
                        ...
                        fab.setOnClickListener(view -> {
                            ...
                            add.setNama(data.getOriginalName());
